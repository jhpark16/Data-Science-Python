...
class SimpleNeuralNetwork(object):
  ...
  def fit(self, X, y, epochs=10000, alpha=0.4, L2=0.0):
...
if __name__ == '__main__':
  ...
  costs = model.fit(Xtrain,ytrain,epochs=100000) # , L2=0.2
  # Calculate model accurcy with X and print
  # The accuracy, Train (0.96), Test(0.94) with L2=0.2
  # The accuracy, Train (0.9875), Test(0.94) with L2=0.0
