...
## Regression
Various linear regressions for multi variables and L1 and L2 regulizations are coded using python numpy vectors and matrices. The following figure shows a polynomial fitting without regulization.
